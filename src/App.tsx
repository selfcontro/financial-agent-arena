...
export function App() {
  ...
  const [view,setView]=useState<'cases'|'summary'|'filters'|'data'>('cases');
  ...
  return <div className="layout">
    <aside className="sidebar"><a className="brand" href="#"><span className="brand-icon">评</span><span>金融 Agent<span className="brand-sub">EVALUATION ARENA</span></span></a>
      ...
      <button className={`case-nav ${view==='data'?'selected':''}`} onClick={()=>setView('data')}>▣ 数据与备份</button>
